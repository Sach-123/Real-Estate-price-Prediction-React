          ...
          <div className="flex justify-center flex-wrap ">
            <div className="p-4 lg:w-1/5 md:w-1/2">
              <div className="h-full flex flex-col items-center text-center">
                <img alt="team" className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src={Mentor} />
                <div className="w-full">
                  <h2 className="title-font font-medium text-lg text-gray-900">Geocey Shejy</h2>
                  <h3 className="text-gray-500 mb-3">Mentor</h3>
            ...
            <div className="p-4 lg:w-1/5 md:w-1/2">
              <div className="h-full flex flex-col items-center text-center">
                ...
                <div className="w-full">
                  <h2 className="title-font font-medium text-lg text-gray-900">Siddhant Kodolkar</h2>
                  <h3 className="text-gray-500 mb-3">Backend Developer</h3>
                  <span className="inline-flex">
            ...
            <div className="p-4 lg:w-1/5 md:w-1/2">
              <div className="h-full flex flex-col items-center text-center">
                <img alt="team" className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src={Sahil} />
                <div className="w-full">
                  <h2 className="title-font font-medium text-lg text-gray-900">Sahil Madhyan</h2>
                  <h3 className="text-gray-500 mb-3">UI Developer</h3>
                  <span className="inline-flex">
